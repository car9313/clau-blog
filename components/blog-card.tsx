...
export function BlogCard({ post }: BlogCardProps) {
  return (
    <Card className="w-full h-full min-h-[400px] max-w-sm hover:shadow-2xl hover:shadow-blue-500/10 dark:hover:shadow-purple-500/20 transition-all duration-500 group hover:-translate-y-2 border-slate-200 dark:border-slate-700 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm flex flex-col">
